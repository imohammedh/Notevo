      ...
      <div className="relative mb-20">
        ...
        <div className="py-5">
          <div className="w-full flex items-center justify-between border-b border-solid border-brand_tertiary/10 py-5 mb-5">
            ...
            <div className="skeleton w-10 h-10 bg-brand_tertiary/20 rounded"></div>
          </div>
            ...
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index}>
                <div className="relative group p-3.5 w-full h-40 border border-solid border-brand_tertiary/10 rounded-lg transition-all duration-300">
                  <div className="skeleton w-full h-6 bg-brand_tertiary/20 rounded mb-2"></div>
                  <div className="skeleton w-full h-4 bg-brand_tertiary/20 rounded mb-1"></div>
                  <div className="skeleton w-10 h-10 absolute top-3 right-0 bg-brand_tertiary/20 rounded"></div>
