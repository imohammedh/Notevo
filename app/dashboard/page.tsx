...
export default function ProductPage() {
  ...
  return (
    <MaxWContainer className=" relative mb-20">
      <div className="w-full text-center py-14 my-5 bg-gradient-to-r from-brand_fourthary via-transparent to-brand_fourthary rounded-xl">
              ...
              <div key={orkspaces._id}>
                {
                  <div className=" relative group p-3.5 w-full h-40 border border-solid border-brand_tertiary/10 rounded-lg transition-all duration-300 hover:border-brand_tertiary/30 hover:scale-y-105">
                    ...
                    <span className="w-10 h-10 absolute top-3 right-0 transition-all duration-200 ease-in-out opacity-50 group-hover:opacity-80">
