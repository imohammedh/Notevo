        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {HowToStartSteps.map((step: Step, index: number) => (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-primary/5 via-secondary/10 to-transparent border-border/20 border border-border/20 rounded-2xl p-6 h-full transition-all duration-300 hover:border-primary/20">
