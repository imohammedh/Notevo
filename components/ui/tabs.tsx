...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg gap-2 bg-brand_fourthary/70 p-1 px-2 text-brand_tertiary ",
      className,
    )}
    {...props}
  />
