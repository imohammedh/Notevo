...
export default function AppSidebar() {
  ...
  return (
    <Sidebar variant="inset" className="border-brand_tertiary/20 group">
      ...
      <SidebarContent className="bg-brand_fourthary text-brand_tertiary/90 transition-all duration-200 ease-in-out scrollbar-thin scrollbar-thumb-brand_fourthary scrollbar-track-transparent-brand_fourthary group-hover:scrollbar-thumb-brand_tertiary">
        <SidebarGroup>
